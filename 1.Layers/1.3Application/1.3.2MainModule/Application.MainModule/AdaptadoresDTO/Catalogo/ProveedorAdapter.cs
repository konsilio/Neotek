    ...
    public static class ProveedorAdapter
    {
        public static Proveedor FromDto(ProveedorCrearDto proveedorDto)
        {
            return new Proveedor()
            {
                ...
                Municipio = proveedorDto.Municipio ?? string.Empty,
                CodigoPostal = proveedorDto.CodigoPostal ?? string.Empty,
                Colonia = proveedorDto.Colonia ?? string.Empty,
                Calle = proveedorDto.Calle ?? string.Empty,
                NumExt = proveedorDto.NumExt ?? string.Empty,
                NumInt = proveedorDto.NumInt ?? string.Empty,
        ...
        public static Proveedor FromDto(ProveedorModificarDto proveedorDto)
        {
            return new Proveedor()
            {
        ...
        public static Proveedor FromEntity(Proveedor proveedor)
        {
            return new Proveedor()
            {
