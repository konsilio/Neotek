...
namespace Application.MainModule.AdaptadoresDTO.Catalogo
{
    public static class UsuarioAdapter
    {
        ...
        public static Usuario FromDtoCredencial(UsuarioCrearDto usDTO, Usuario usr)
        {
        ...
        public static Usuario FromDTOEditar(UsuarioCrearDto usuariodto, Usuario catUser)
        {
