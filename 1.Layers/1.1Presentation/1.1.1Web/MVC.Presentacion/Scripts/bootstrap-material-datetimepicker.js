(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'DD-MM-YYYY', minDate: null, maxDate: null, currentDate: null, lang: 'es', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'Cancelar', okText: 'Aceptar', clearText: 'Limpiar', nowText: 'Hoy', switchOnClick: false};
