...
namespace MVC.Presentacion.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public ActionResult Nuevo()
        {
            ...
            ViewBag.Estatus = PedidosServicio.ObtenerEstatusPedidos(_tkn);
        ...
        public ActionResult BuscarClientesPedido(PedidoModel model)
        {
            if (Session["StringToken"] == null) return RedirectToAction("Index", "Home", AutenticacionServicio.InitIndex(new Models.Seguridad.LoginModel()));
            string _tkn = Session["StringToken"].ToString();
            var lstClientes = CatalogoServicio.ListaClientes(model.Celular1, model.Telefono1, model.Rfc, _tkn);
