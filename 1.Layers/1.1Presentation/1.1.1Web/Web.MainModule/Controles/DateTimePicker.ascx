...
<table cellpadding="0" cellspacing="0" ><tr><td style="vertical-align: middle"> 
    ...
    <asp:Image ID="imgDatePicker" runat="server" ImageUrl="~/fonts/cal.png" Style="CURSOR: auto; width:30px; height:30px; image-rendering:inherit;" />
        <asp:TextBox ID="tbDatePicker" Enabled="true" runat="server" CssClass="form-control" Style="TEXT-ALIGN: center;" ForeColor="Black" ></asp:TextBox></div><asp:RequiredFieldValidator
...
<cc1:CalendarExtender ID="ceDatePicker" runat="server" CssClass="MyCalendar z-index" Format="dd/MM/yyyy"
