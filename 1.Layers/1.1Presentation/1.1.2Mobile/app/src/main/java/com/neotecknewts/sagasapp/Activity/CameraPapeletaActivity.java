 ...
 */
public class CameraPapeletaActivity extends AppCompatActivity implements CameraDescargaView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_papeleta);
        ...
        dialog = new ProgressDialog(com.neotecknewts.sagasapp.Activity.CameraPapeletaActivity.this);
        ...
        permisos = new Permisos(com.neotecknewts.sagasapp.Activity.CameraPapeletaActivity.this);
        permisos.permisos();
...
//            layoutTitle.setVisibility(View.VISIBLE);
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (iniciar) {
                ...
                builder.setPositiveButton(getString(R.string.label_si), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
                        Intent intent = new Intent(com.neotecknewts.sagasapp.Activity.CameraPapeletaActivity.this, IniciarDescargaActivity.class);
    ...
    private void startActivityTraspaso() {
        ...
        if (EsTraspasoEstacionInicial || EsTraspasoEstacionFinal) {
            EsPrimeraParteTraspaso = false;
            Intent intent = new Intent(com.neotecknewts.sagasapp.Activity.CameraPapeletaActivity.this, LecturaP5000Activity.class);
