        ...
        if (extras != null) {
            ...
            //si es finalizar descarga se cambian los textos y se obtiene el objeto del activity anterior
                ...
                if (porcentaje_inicial > 0) {
                    ...
                    Log.d("numberpicker", numberPickerDecimal.toString());
                    Log.d("decimal", parte_decimal + "");
                    Log.d("entero", parte_entera + "");
            ...
            new NumberPicker.OnValueChangeListener() {
                ...
                public void onValueChange(NumberPicker numberPicker, int i, int i1) {
                    ...
                    if (EsLecturaInicial || EsLecturaFinal) {
                        ...
                        Log.v("NumberPickerpipaentero", numberPickerProcentaje.getValue() + "");
                        Log.v("NumberPickerpipadecimal", numberPickerDecimal.getValue() + "");
                        Log.v("numberPickerProcentaje", numberPickerProcentaje + "");
                        TotalGas = (lecturaPipaDTO.getCapacidadAlmacen() * porcentajeCalculo) / 100;
                        Log.v("totalgaspipa", TotalGas + "");
                        TVCapturaPorcentajeActivityTotalGas.setText(
                                "Total de gas aproximado: " + String.valueOf(TotalGas) + "Lt.");
