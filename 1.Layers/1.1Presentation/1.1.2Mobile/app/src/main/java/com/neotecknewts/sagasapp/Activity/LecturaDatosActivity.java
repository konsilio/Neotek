...
public class LecturaDatosActivity extends AppCompatActivity implements View.OnClickListener ,
    ...
    public com.neotecknewts.sagasapp.Model.DatosTomaLecturaDto DatosTomaLecturaDto;
    ...
    @Override
    public void onSuccessEstacionesCarburacion(com.neotecknewts.sagasapp.Model.DatosTomaLecturaDto data) {
