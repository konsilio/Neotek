...
import com.neotecknewts.sagasapp.Presenter.LecturaPipaPresenter;
import com.neotecknewts.sagasapp.Presenter.LecturaPipaPresenterImpl;
...
public class LecturaPipaActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    com.neotecknewts.sagasapp.Model.DatosTomaLecturaDto DatosTomaLecturaDto;
    ...
    @Override
    public void onSuccessPipas(com.neotecknewts.sagasapp.Model.DatosTomaLecturaDto data) {
