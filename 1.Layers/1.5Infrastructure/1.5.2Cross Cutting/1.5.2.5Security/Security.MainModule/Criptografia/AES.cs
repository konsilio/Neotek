...
namespace Security.MainModule.Criptografia
{
    ...
    public class AES
    {
        // Ejemplo de como se utilizan los métodos de encriptación y desencriptación
        ...
        public static byte[] Encriptar(string texto, byte[] Key)
        {
            return EncryptStringToBytes_Aes(texto, Key);
        }
        public static string Desencriptar(byte[] textCifrado, byte[] Key)
        {
            return DecryptStringFromBytes_Aes(textCifrado, Key);
        }
