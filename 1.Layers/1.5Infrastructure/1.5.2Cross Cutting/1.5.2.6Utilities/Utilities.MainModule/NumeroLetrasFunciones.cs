...
{
    public class NumeroLetrasFunciones
    {
        ...
        public NumeroLetrasFunciones(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return NumeroLetrasFunciones.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }
